...
\everymath{\displaystyle}
	...
	\part{Модели освещения}
	\frame{\partpage}
	
	\begin{frame}\frametitle{Red Dead Redemption 2 + shading mod}
		
		\centering\includegraphics[width=0.95\textwidth]{rdr2}
		
	\end{frame}	
	
	\begin{frame}\frametitle{Компоненты освещения}
		\centering
		$I=I_a+I_d+I_s$
	...
	\section[Ламберт]{Модель Ламберта}
	
	\begin{frame}\frametitle{Модель Ламберта}
	...
	\end{frame}
\section[Wrap-around]{Wrap-around}
	\begin{frame}\frametitle{Wrap-around}
		\centering $I=\dfrac{\max\big(0,(\VV l \cdot \VV n)\big)+f}{1+f}$
		
		\includegraphics[width=0.4\textwidth]{warp.jpg}~\includegraphics{warp.pdf}
	\end{frame}
 
 \begin{frame}\frametitle{Модель Фонга (Phong lightning model)}
 	\TC{0.5}
 	{
 ...
 \section[Фонг]{Модель Фонга}
  ...
  \begin{frame}\frametitle{Модель Фонга (Phong lightning model)}
 	...
 	\section[Блинн]{Модель Блинна}
 
 \begin{frame}\frametitle{Модель Блинна  (Фонга - Блинна)}
 	...
 	}
 	{
 		...
 		$I_s=\max\big(0,(\VV n \cdot \VV h)^k \big)$
 ...
 \section[Вард]{Модель Варда}
 
 \begin{frame}\frametitle{Модель Варда}
 ...
 \section[Орен-Наяр]{Модель Орена - Наяра}
 \begin{frame}\frametitle{Модель Орена - Наяра}
 ...
 \end{frame}
  ...
  \section[Кук-Торранс]{Модель Кука-Торранса}
 
  \begin{frame}\frametitle{Модель Кука-Торранса}
 ...
 \section[Однотонная]{Однотонная закраска}
 
 \begin{frame}\frametitle{Однотонная закраска}
 	\TC{0.5}
 ...
 \end{frame}
  ...
  \section[Гуро]{Закраска по Гуро}
  

  
  \begin{frame}\frametitle{Закраска по Гуро}
  ...
  \end{frame}
   ...
   \section[Фонг]{Закраска по Фонгу}
   
    \begin{frame}\frametitle {Закраска по Фонгу}
