...
\begin{frame}\frametitle{Поверхность на основе b-сплайна}
	...
	\TC{0.45}
	{
		...
		$U=\{\rememb{n1}0, \dots{}, 0\rememb{n2},\rememb{n3}\dots{},i-p,\dots\rememb{n4}, \rememb{n5}n-p+1 \rememb{n6}\}$
		
		\begin{tikzpicture}[overlay, remember picture]
			
			
			\draw[decorate,decoration={brace,amplitude=5pt,mirror,raise=1ex}] (n1) -- (n2) node[below, midway, yshift=-1.5ex] {$[0,  p]$};
			\draw[decorate,decoration={brace,amplitude=5pt,mirror,raise=1ex}] (n3) -- (n4) node[below, midway, yshift=-1.5ex] {$[p+1,  n]$};
			\draw[decorate,decoration={brace,amplitude=5pt,mirror,raise=1ex}] (n5) -- (n6) node[below, midway, yshift=-1.5ex,  xshift=2ex] {$[n+1,  n+p+1]$};
			
		\end{tikzpicture}
		
		\vspace{3ex}
		
		$V=\{\rememb{n1}0, \dots{}, 0\rememb{n2},\rememb{n3}\dots{},i-q,\dots\rememb{n4}, \rememb{n5}m-q+1\rememb{n6}\}$
		
		\begin{tikzpicture}[overlay, remember picture]
		
			\draw[decorate,decoration={brace,amplitude=5pt,mirror,raise=1ex}] (n1) -- (n2) node[below, midway, yshift=-1.5ex] {$[0,  q]$};
			\draw[decorate,decoration={brace,amplitude=5pt,mirror,raise=1ex}] (n3) -- (n4) node[below, midway, yshift=-1.5ex] {$[q+1,  m]$};
			\draw[decorate,decoration={brace,amplitude=5pt,mirror,raise=1ex}] (n5) -- (n6) node[below, midway, yshift=-1.5ex,  xshift=2ex] {$[m+1,  m+q+1]$};
...
\begin{frame}\frametitle{NURBS-поверхность}
	...
	\pause
	$U=\{\rememb{n1}0, \dots{}, 0\rememb{n2},\rememb{n3}\dots{},(i-p)/(n-p+1),\dots\rememb{n4}, \rememb{n5}1, \dots ,1  \rememb{n6}\}$
	...
	$V=\{\rememb{n1}0, \dots{}, 0\rememb{n2},\rememb{n3}\dots{},(i-q)/(m-q+1),\dots\rememb{n4}, \rememb{n5}1, \dots ,1  \rememb{n6}\}$
...
\begin{frame}\frametitle{Поверхность пятого порядка $(p=q=4)$}
...
\begin{frame}\frametitle{Поверхность четвертого порядка $(p=q=3)$}
...
\begin{frame}\frametitle{Поверхность третьего порядка $(p=q=2)$}
...
\begin{frame}\frametitle{Поверхность второго порядка} $(p=q=1)$
	...
	\TC{0.5}
	{
		...
		$\VV S(u,v)=\sum_{i=0}^4\sum_{j=0}^4R_{i,j}^{1,1}(u,v)P_{i,j}$,
...
\begin{frame}\frametitle{Поверхность втор...етьего порядка $(p=2, q=1)$}
	
	\TC{0.5}
	{
		\animategraphics[autoplay,loop, nomouse]{15}{Images/\jobname/nurbs_surf_order2-3}{0}{71}
	}{
		$\VV S(u,v)=\sum_{i=0}^4\sum_{j=0}^4R_{i,j}^{2,1}(u,v)P_{i,j}$,
